...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/steep-rice-6738)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/steep-rice-6738
```

A live public deployment of this template is available at [https://steep-rice-6738.templates.workers.dev](https://steep-rice-6738.templates.workers.dev)
